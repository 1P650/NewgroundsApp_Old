...
public class GridItemViewSmall extends View implements Target<Drawable> {
    ...
    public GridItemViewSmall(Context context) {
        super(context);
        establishState();
    }

    public GridItemViewSmall(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        establishState();
    }

    public GridItemViewSmall(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        establishState();
    }

    public GridItemViewSmall(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setDashItem(GridItemSmall item){
        Glide.
                with(getContext())
                .load(item.getImage())
    ...
    private void establishState(){
        ...
        DashAuthorPainter.setTextSize(sp(13));
